<template>
<div class="mainPage">
    <div class="currentLocation">当前位置：首页 > 最新服务 > 大学生创业吸纳就业奖励</div>
    </br>
    <div class="first-inline">
        <div class="line"><div class="redTag"></div>大学生创业吸纳就业奖励</div>
        <div class="applyBtn">
            <!-- Form -->
            ...
            <div class="applyHead">
                ...
                <span class="applyTileText"><span class="firstText"> | 政务一卡通 </span>| 大学生创业吸纳就业奖励申请</span>
             </div>
                <el-form :model="form">
    ...
    <div class="downloadFiles">
        ...
        <div class="filesList">
            <a id="linkUrl1" href="" class="linkType" title="下载">大学生创业吸纳就业奖励申请材料清单</a>
            <a id="linkUrl2" href="" class="linkType" title="下载">大学生创业吸纳就业奖励申请表</a>
        </div>
    </div>
</div>
</template>
